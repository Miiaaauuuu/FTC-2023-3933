...
@Autonomous(name="PlanB_ROJO", group="Robot")
//@Autonomous(name="BlueIzquierda", group="Linear Opmode")
@Disabled
public class PlanB_ROJO extends LinearOpMode {
    ...
    public void runOpMode() {
       ...
       //Aqui empieza el programa
           ...
           // Atras(1);
            ...
            Izquierda(1.1); //vamossssssssssssssssssssssssssssssss
    ...
    sleep(10);
        ...
        else if(verde>rojo && verde>azul && verde>ColorDrift+(ColorDrift*0.90)){ // verde 2  cent
            colorD = 2;
            Derecha(0.3);
            Adelante(0.2);
